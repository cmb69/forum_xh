...
function forum_user() {
    ...
    return isset($_SESSION['Name']) ? $_SESSION['Name'] : (
       isset($_SESSION['fullname']) ? $_SESSION['fullname'] : FALSE);
}
...
function forum_comment_form($tid = NULL) {
    ...
    if (!isset($tid)) {
   $o .= '<div class="forum_navlink_box" align="right">'.'<div class="forum_navlink">'.'<a href="?'.$su.'">'.$ptx['msg_back'].'</a>'.'</div>'.'</div>';
...
function forum_view_topics($forum) {
      ...
      if (forum_user() !== FALSE) {
         ...
         $o = '<div class="forum_navlink_box" align="right">'.'<div class="forum_navlink"><a href="'.$href.'">'.$ptx['msg_start_topic'].'</a></div>'.'</div>'
            .'<h6 class="forum_heading">'.$ptx['msg_topics'].'</h6>'
...
function forum_view_topic($forum, $tid) {
    ...
    forum_lock($forum, LOCK_UN);
    $href = "?$su";
   $o = '<div class="forum_navlink_box" align="right">'.'<div class="forum_navlink"><a href="'.$href.'">'.$ptx['msg_back'].'</a></div>'.'</div>'
      .'<h6 class="forum_heading">'.htmlspecialchars($topics[$tid]['title'], ENT_NOQUOTES, 'UTF-8').'</h6>'
